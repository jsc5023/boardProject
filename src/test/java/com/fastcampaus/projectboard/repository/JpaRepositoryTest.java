...
import com.fastcampaus.projectboard.domain.Hashtag;
...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newJsc", "pw", null, null, null));
    ...
    void givenArticleCommentIdHavingChildCommentsAndUserId_whenDeletingParentComment_thenDeletesEveryComment() {
        ...
        // When
        articleCommentRepository.deleteByIdAndUserAccount_UserId(1L, "jsc");
    ...
    @Test
    void givenHashtagNamesPageable_whenQueryingArticles_thenReturnsArticlePages() {
        // Given
        ...
        // Then
        assertThat(articlePage.getContent().get(0).getTitle()).isEqualTo("Aenean fermentum.");
        assertThat(articlePage.getContent().get(0).getHashtags())
                .extracting("hashtagName", String.class)
                .containsExactly("Fuscia");
        assertThat(articlePage.getTotalElements()).isEqualTo(37);
        assertThat(articlePage.getTotalPages()).isEqualTo(8);
    }
