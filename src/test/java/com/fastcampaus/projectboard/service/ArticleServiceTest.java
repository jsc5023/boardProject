...
import com.fastcampaus.projectboard.repository.HashtagRepository;
...
class ArticleServiceTest {
    ...
    @DisplayName("검색어 없이 게시글의 해시태그를 검색하면, 빈 페이지를 반환한다.")
    @Test
    ...
    @DisplayName("게시글의 해시태그를 검색하면, 게시글 페이지를 반환한다.")
    @Test
    ...
    @DisplayName("게시글 ID로 조회하면, 댓글이 달린 게시글을 반환한다.")
    @Test
