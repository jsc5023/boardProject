...
import com.fastcampaus.projectboard.config.SecurityConfig;
import com.fastcampaus.projectboard.config.TestSecurityConfig;
import com.fastcampaus.projectboard.domain.constant.FormStatus;
...
import com.fastcampaus.projectboard.dto.request.ArticleRequest;
...
import com.fastcampaus.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenPagingAndSortingParams_whenSearchingArticleView_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "jscTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][POST] 게시글 수정 - 정상호출")
    @Test
    ...
    @Test
    public void givenArticleIdToDelete_whenRequesting_thenDeletesArticle() throws Exception {
        // Given
        Long articleId = 1L;
